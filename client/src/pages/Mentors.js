...
function Mentors() {
  const mentors = [
    ...
    {
  name: 'Priya Patel',
  company: 'Blibli (Indonesia)',
  role: 'Software Engineer',
  college: 'Nirma University, Ahmedabad',
  skills: ['Java', 'Spring Boot', 'Microservices', 'Kafka', 'MongoDB', 'Redis'],
  available: true,
  email: 'priyaa737.p@gmail.com',
  linkedin: 'https://linkedin.com/in/priyapatel',
  instagram: 'https://instagram.com/priyapatel_dev',
  facebook: 'https://facebook.com',
  wikipedia: '',
  journey: `Priya Patel graduated from Nirma University in 2020 with a Bachelor's in Technology in Computer Engineering. She has 2 years of experience as a Software Engineer at Blibli, a leading Indonesian eCommerce platform, where she develops scalable backend services using Java and Spring Boot. She has hands-on experience with microservices architecture, distributed systems, REST APIs, and databases like Postgres, MongoDB, Redis, and Kafka. She is passionate about learning new technologies and solving complex problems in fast-paced agile environments. She can be reached at priyaa737.p@gmail.com for work opportunities.`,
},
    {
      name: 'Amit Singh',
      company: 'Amazon',
