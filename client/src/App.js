    ...
    <div style={{ backgroundColor: 'transparent', color: 'white', minHeight: '100vh', padding: '40px' }}>
        ...
        {companies.map(company => (
          <button
            ...
            style={{
              ...
              cursor: 'pointer',
              fontSize: '0.9rem',
              fontWeight: activeFilter === company ? 'bold' : 'normal',
              transition: 'all 0.2s'
            }}>
            {company}
          </button>
      ...
      {showPopup && (
        <div style={{
          ...
          <div style={{
            backgroundColor: '#0f172a', border: '2px solid #4ade80', borderRadius: '20px',
            padding: '40px', maxWidth: '440px', width: '90%', textAlign: 'center',
            boxShadow: '0 0 40px rgba(74,222,128,0.3)'
          }}>
            <div style={{ fontSize: '3rem', marginBottom: '16px' }}>📚</div>
            <h2 style={{ color: '#4ade80', fontSize: '1.5rem', fontWeight: 'bold', marginBottom: '12px' }}>
              Want to Open a DSA Sheet?
            </h2>
            <p style={{ color: '#94a3b8', fontSize: '0.95rem', marginBottom: '32px', lineHeight: '1.6' }}>
              You've been on Prep Hub for a while! Level up with a structured DSA sheet — Striver, Love Babbar, or Apna College. 🚀
            </p>
            <div style={{ display: 'flex', gap: '16px', justifyContent: 'center' }}>
              <button
                onClick={handleOpenDSA}
                style={{
                  backgroundColor: '#4ade80', color: '#111827', padding: '12px 28px',
              ...
              <button
                ...
                style={{
                  backgroundColor: '#1e293b', color: '#94a3b8', padding: '12px 28px',
      ...
      {showDSAModal && (
        <div style={{
          ...
          <div style={{
            backgroundColor: '#0f172a', border: '2px solid #4ade80', borderRadius: '20px',
            padding: '40px', maxWidth: '560px', width: '90%',
            boxShadow: '0 0 40px rgba(74,222,128,0.3)'
          }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              {dsaSheets.map((sheet, i) => (
                <div key={i} style={{
                  ...
                  border: `1px solid ${sheet.color}33`,
                  ...
                  <div style={{ flex: 1 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '6px' }}>
                      ...
                      <span style={{
                        backgroundColor: `${sheet.color}22`, color: sheet.color,
                  ...
                  <a
                    ...
                    style={{
                      backgroundColor: sheet.color, color: '#111827',
                      padding: '10px 20px', borderRadius: '8px', fontWeight: 'bold',
                      fontSize: '0.85rem', textDecoration: 'none', whiteSpace: 'nowrap'
                    }}>
                    Open →
                  </a>
                </div>
